let mapPlayer,mergeObjects,flattenObject,mapPlayers;_850‍.x([["mapTeam",()=>mapTeam],["mapRoster",()=>mapRoster],["mapStats",()=>mapStats],["mapDraft",()=>mapDraft],["mapMatchups",()=>mapMatchups],["mapTeamPoints",()=>mapTeamPoints],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection],["parseGameCollection",()=>parseGameCollection]]);_850‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);_850‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}],["flattenObject",["flattenObject"],function(v){flattenObject=v}]]);_850‍.w("./gameHelper.mjs",[["mapPlayers",["mapPlayers"],function(v){mapPlayers=v}]]);



       function mapTeam(t) {
  const team = _850‍.a("mergeObjects",mergeObjects)(t);
  // clean up team_logos
  ...
  return _850‍.a("mapPlayers",mapPlayers)(players);
}
